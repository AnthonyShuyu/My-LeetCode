...
// s1: sweeping line, TreeMap / HashHeap
// O(nlogn), O(n)

public class Solution {
    
    
    // implement a HashHeap to support remove(element) in T = O(logn) 
    class HashHeap {
        List<Integer> heap;
        String mode;
        int size_t;
...
public ArrayList<ArrayList<Integer>> getSkyline(int[][] buildings) {
